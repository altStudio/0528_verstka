...
<body class="body">
    ...
    <div class="sections-block">
        <div class="secondsect-father">
            <div class="section-2 screenone section first not-padding-top first-head-section wf-section"
                ...
                <div class="section-inner first-inner">
                    <div class="container-3 wrapper w-container">
                        <div class="scroll-dv">
                            <div class="text-block-39">swipe to discover</div><img
                    ...
                    <img src="./images/bg-main-page.png" loading="eager" sizes="100vw" alt="" class="image-7" />
                    <img src="./images/bg-main-page2.png" loading="eager" sizes="100vw" alt="" class="image-6" />
                    ...
                    alt="" class="image-40" />
                <img src="./images/Glasses-left-side.png" class="image-40 mob-glass">
                <img src="./images/glasses-2.png" width="2700" loading="eager" alt="" class="image-42" />
            </div>
            <div id="start" class="secondsect section connect-section wf-section not-rendering"
                style="position: relative;">
                <img src="./images/bg-first-video.png" alt="" class="bg-first-video-img">
                            ...
                            <div class="section-content not-padding">
                                ...
                                <div class="div-block-7">
                                    <div class="div-block-5"><img width="200" src="./images/MetaPax.svg" loading="lazy"
                                            alt="" class="image-9" />
                                        <div class="text-block-4">Connecting people in <br /><span
            ...
            <div id="3sec" class="section-3 section wf-section not-rendering">
                <div class="container-4 wrapper w-container">
                    <div class="section-content margin-top-none not-padding">
                        <div class="section-header"><img src="./images/logo.svg" loading="lazy" alt=""
                                class="site-logo" />
                            <div class="site-menu custom-menu">menu</div>
                        </div>
                        ...
                        <div class="div-for-absolute-position">
                            ...
                            <div class="content-bottom flex-end w-row">
                                <div class="w-col w-col-10">
                                    <div class="mobile-section-title">
                                        <div class="mobile-section-title-item">Limitless <br />possibilities.</div>
                                        <div class="mobile-section-title-item-hidden">Immersive <br />Experience</div>
                                    </div>
                                    <div class="center-text visible-text">Interacting with people on the other side of
                                        the
                                        globe without leaving the comfort of your living room, or renting an apartment
                                        for
                                        your future travel -- possibilities are limited by your imagination.</div>
                                    <div class="center-text hidden-text-2"><span class="text-span-28">Feel something
                                            that
                                            wasn’t possible before.</span><br /> Have you ever thought how the musical
                                        performance would look like from the eyes of your favourite singer?<br />&nbsp;
                                    </div>
                                </div>
                ...
                </div><img src="./images/gradient-3.png" loading="eager" sizes="(max-width: 1884px) 100vw, 1884px"
                    ...
                    alt="" class="image-10" /><img src="./images/gradient-4.png" loading="eager"
                    sizes="(max-width: 1395px) 100vw, 1395px" alt="" class="image-11" />
            </div>
            <div class="section-4 section special-sect wf-section not-rendering">
                ...
                <div class="wrapper width-100">
                    <div class="section-content not-padding">
                        ...
                        <div class="text-container margin-top-auto">
                            <div class="div-for-relative-position" style="height: 255px;">
                                <img src="./images/glasses-with-shadow.png" alt="" class="glasses-in-now-you-can">
                                <div class="text-blocks-holder">
                                    <div class="text-block-14 hidden-title">Now you can!</div>
                                    <div class="text-block-15 hidden-subtitle">Fully controlable tasks <br />like never
                                        before
                                    </div>
                                </div>
                            </div>
                ...
                <img src="./images/now-you-can-gradient.png" class="now-you-can-bg" alt="">
            </div>
            <div class="section-5 section special-sect wf-section not-rendering">
                <img src="./images/video-placeholder.png" alt="" class="img-bg">
                <div class="container-4 wrapper w-container">
            ...
            <div class="section-5 section section-6 eye-section wf-section not-rendering">
                ...
                <div class="container-4 wrapper w-container">
                    <div class="section-content not-padding">
                        ...
                        <div class="content-center w-row" style="transform: translate(0, 30px);">
                            <div class="eye-container"><img src="./images/sauron.png" loading="eager"
                                    ...
                                    alt="" class="image-43" />
                                <div class="text-block-56">Social networks evolved</div>
                                <div class="text-block-58">The line between real and virtual is gone</div>
                            </div>
                            <div class="how-works-bottom-text w-col w-col-10">
                                <div class="text-go center-text alantext">We are building a bridge to Metaverse of
                                    experience where people can become whoever they choose.</div>
                                <div class="text-go center-text content-bottom-second-hiiden-text"><span
                                    ...
                                    proud community where network effects are organically built into the product
            ...
            <div id="get" class="section section-7 platform-section wf-section not-rendering">
                <div class="wrapper w-container">
                    <div class="circle-layers"><img src="./images/bg-purple-circl.svg" alt="" class="layers-1" /><img
                            ...
                            alt="" class="layers-2" /><img src="./images/Group_2037.png" sizes="100vw" alt=""
                            class="image-21" /></div>
                        ...
                        <div class="what-do-content">
                            <div class="what-do-text">
                                ...
                                <div class="div-block-26">
                                    <div class="text-block-17 marcel-1">Open platform <br />and create a deal
                                    </div>
            ...
            <div id="time" class="section white-section time-section wf-section not-rendering">
                ...
                <div class="wrapper w-container">
                    <div class="section-content not-padding no-flex">
                        ...
                        <div class="matters-container">
                            <h2 class="heading h2">The only real <br />option to buy</h2>
                            <div class="div-block-10">
                                <div class="text-block-26">TIMETIMETIMETIME</div>
                            </div>
                            <div class="content-bottom flex-end margin-top-auto w-row" style="margin-bottom: 0;">
                                <div class="how-works-bottom-text text-block-18 w-col w-col-10">
                                    <div class="text-block-61">What do we exchange?</div>
                                    <div class="text-go center-text _w-960">Streamers are monetizing their experiences, sharing them with the people across the globe.

                                        Viewers are buying new experiences to live through -- saving a lot of their own
                                        time in the process.
                                    </div>
                                </div>
                                <div class="column-2 pagin pagin-revert w-col w-col-2">
            ...
            <div id="howto" class="section section-ways-slider _wf-section wf-section not-rendering">
                <div class="wrapper w-container">
                    <div class="section-content not-padding">
                        ...
                        <div class="horizontal-swipe-icon">
                            <img src="./images/swipe-horizontal.svg" alt="Horizontal swipe" />
                        </div>
                            ...
                            <div class="ways-slider">
                                ...
                                <div class="ways-slider-item">
                                    <div class="ways-slider-item_text">
                                        <div class='container-slide-indicator' style="display: none">
                                            <div class='container-slide-indicator__item-active'>
                                            </div>
                                            <div class='container-slide-indicator__item'>
                                            </div>
                                            <div class='container-slide-indicator__item'>
                                            </div>
                                            <div class='container-slide-indicator__item'>
                                        ...
                                        <div class="text-block-29">Reimagine human possibilities and ways to connect.
                                            Unlimited ways to MetaPax through life</div>
                                    </div>
                                    ...
                                    <div class="slider-bottom-text text-style">
                                        <div class="text-block-64">Ride a mountain bike or fly a paraglider over
                                            South Africa together with your friends - guide the pilot as you
                                            wish - speed, locations, explore all the details...<br /><br />No risk and
                                            <span class="text-span-34">plenty of joy!</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="ways-slider-item">
                                    ...
                                    <div class="slider-bottom-text text-style">
                                        <div class="text-block-64">Are you a <span class="text-span-35">fellow student
                                                or a scientist?</span> Now you can get your productivity to the
                                            next level - connecting to the scientific facilities or researchers
                                            themselves, discuss new ideas or ongoing progress with them.</div>
                                    </div>
                                </div>
                                <div class="ways-slider-item">
                                    <div class="ways-slider-item_text">
                                        ...
                                        <h3 class="heading-2">Work &amp; Business</h3>
                                    </div>
                                    ...
                                    <div class="slider-bottom-text text-style">
                                        <div class="text-block-64">Professional photographer? We have your
                                            back. With MetaPax you don’t need to travel for a good views
                                            anymore. Harness MetaPax network of streamers and create <span
                                                class="text-span-36">any content you want whenever you
                                                want.</span></div>
                                    </div>
                                </div>
                                <div class="ways-slider-item">
                                    <div class="ways-slider-item_text">
                                        ...
                                        <h3 class="heading-2">Orders &amp; Errands</h3>
                                    </div>
                                    ...
                                    <div class="slider-bottom-text text-style">
                                        <div class="text-block-64"><span class="text-span-37">Distance is not a problem
                                                anymore</span> -- if you’d like to send some gestures of love to
                                            your family, remotely organize event at specific venue or make fun of
                                            your closest friend -- it’s possible with MetaPax, not matter
                                            where in world you are.</div>
                                    </div>
                                </div>
                            </div>
            ...
            <div
                class="section-10 section section-invert _wf-section wf-section bg-pax-creator not-rendering zero-opacity">
                <div class="container-4 wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                        <div class="section-header"><img src="./images/logo.svg" loading="lazy"
                                alt="" class="site-logo" />
                            <div class="site-menu custom-menu">menu</div>
                        </div>
                        <div class="text-block-32 not-margin-top">Pax<br /><span class="text-span-9">creator</span>
                        </div>
                        <div class="div-for-absolute-position">
                            <div class="div-for-absolute-position-fix-height">
                                <img src="data:image/svg+xml;base64,"
                                    alt="" class="image-26 image-desktop" />
                                <img src="./images/girl-with-logo.svg" loading="lazy" alt="" class="image-27" />
                                <div class="pax-creator-content">
                                    <div class="text-block-33 gradient-text font-size-120">
                                        Invents<br />Explores<br />Enjoys
                                    </div>
                                </div>
                            </div>
                            <div class="content-bottom flex-end w-row being-beholder-text">
                                <div class="how-works-bottom-text-invents w-col w-col-10">
                                    <div class="text-go center-text _w-960">Being Beholder is very rewarding -- but it
                                        also
                                        is a responsibility. A
                                        <span class="text-span-14">constant learning</span> on how to interact with
                                        streamers and how to get the
                                        best out of it... But in the end there is nothing more joyful than to be the one
                                        who
                                ...
                                <div class="column-2 pagin pagin-revert w-col w-col-2">
                                    <div class="text-block-34 pagin-white">03<span
                                            class="text-span-8 subpagin-black">/10</span></div>
                                    <div class="text-block-34 not-border-bottom intro-black">MetaPax <br />beholder
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div
                class="section-10 section-monic section _wf-section magic-section wf-section bg-pax-creator not-rendering zero-opacity">
                <div class="container-4 wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                        <div class="section-header"><img src="./images/logo.svg" loading="lazy" alt=""
                                class="site-logo" />
                        ...
                        <div class="div-block-14 div-for-absolute-position">
                            <div class="div-block-25">
                                <div class="text-block-35">Magic <br /> begins</div>
                                <div class="text-block-29">It’s you who decides what happens next.
                            ...
                            <div class="content-bottom flex-end w-row">
                                <div class="how-works-bottom-text w-col w-col-10 text-block-65">
                                    <div class="text-go center-text _w-960">Get your task done. Play with the narrative
                                        to
                                        appease the spectators if your stream is public. Successfull evolution of the
                                        story
                                        can even make your stream free for you: people can donate and support you
                                        real-time.
                                    </div>
                                </div>
                                <div class="column-2 pagin pagin-revert w-col w-col-2">
            ...
            <div
                class="section-10 section section-earn _wf-section wf-section bg-earn-learn-evolve not-rendering zero-opacity">
                <div class="container-4 wrapper w-container">
                    <div class="section-content space-between margin-top-none not-padding">
                        ...
                        <div class="text-block-32 text-head not-margin-top header-title"><span
                            class="text-span-9">Paxer</span></div>
                        <div class="div-for-absolute-position">
                        <div class="div-block-27"><img
                                ...
                                alt="" class="image-26" />
                            <div class="text-block-33 gradient-text new font-size-120">Earns<br />Evolves<br />Learns
                            </div><img src="./images/boy-with-glasses.svg" loading="lazy" alt=""
                        ...
                        <div class="content-bottom flex-end w-row">
                            <div class="how-works-bottom-text w-col w-col-10">
                                <div class="text-go center-text _w-960 regular-text">Traveller, local geek or science prodigy --
                                    whoever you are, MetaPax awaits. Millions of people around the globe are waiting to
                                    explore your talents and deep dive in
                                    your incredibly interesting life. <br /> <br /> Don’t be shy to share it, and you’ll
                                    be suprised by how much you could benefit from it.</div>
                            </div>
                            <div class="column-2 pagin pagin-revert w-col w-col-2">
            ...
            <div class="section-10 section-offer _wf-section earns-section-2 section wf-section bg-pax-creator not-rendering zero-opacity">
                <div class="container-4 wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                        <div class="section-header"><img src="./images/logo.svg" loading="lazy" alt=""
                                class="site-logo" />
                        ...
                        <div class="columns-11 w-row div-for-absolute-position">
                            <div class="w-col w-col-3">
                                <div class="div-block-21">
                                    <div class="text-block-35">Earns Evolves Learns</div>
                                    <div class="text-block-29">You don't need a story, <span class="text-span-29">you are the story.</span>

                                        Each paxer has something to offer to the community.</div>
                                </div>
                            </div>
            ...
            <div id="howitworks" class="section how-works-section _wf-section wf-section not-rendering zero-opacity">
                <div class="wrapper wrapper-relative w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                            ...
                            <div class="div-block-24">
                                <div class="mobile-hiw-images"><img src="./images/how-work-glasses.png" loading="lazy"
                                    ...
                                    <div class="div-block-29">
                                        ...
                                        <div class="text-block-38 title-visible">Streaming FPV Glasses</div>
                                    </div>
                                </div>
                            </div>
                            <div class="div-block-30">
                                <div class="text-block-38 title-visible desctop">Streaming<br />FPV Device</div>
                                <div class="text-block-51 titile-invs desktop">MetaPax<br />platform &amp; app
                                </div>
                                <div class="div-block-31">
                                    <div class="text-go center-text hiw-unvis">Install the app, put on your device --
                                        and you will immediately start streaming to the millions of people around the
                                        globe who are curious to learn and see through your eyes.</div>
                                    <div class="text-go center-text hiw-vis">They key element of the MetaPax platform is
                                        the ability to work with literally any wearable device out there, be it Smart
                                        Glasses, GoPro Cameras, you name it.</div>
                                </div>
                            </div>
                        ...
                        <div class="text-block-37" style="display: none;">It was hard <br />to deliver your <br />vision until now</div>
                        <div class="content-bottom flex-end w-row">
            ...
            <div class="section marque-glasses _wf-section wf-section not-rendering zero-opacity">
                <img src="./images/glasses-vertical.png" alt="" class="vertical-glasses-img">
                <img src="./images/music-waves.png" alt="" class="music-waves-img">
                <div class="wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none align-center">
                        ...
                        <div class="section-title">
                            <h3 class="heading-9 header-title" style="font-size: 22px; margin-bottom: 3vh;">No language barrier.</h3>
                            <div class="text-block-41" style="color: white;">MetaPax platform developed an AI that
                                translates text and voice to over 100 different languages -- on the go. Nothing will
                                stop you from the best experience of your life.
                        </div>
                        </div>
                    </div>
                </div>
                <img src="./images/Mask Group (1).png" class="text-circle-container__right-text" style="display: none" />
                <img src="./images/Mask Group.png" class="text-circle-container__left-text" style="display: none" />

                <div class="text-circle-container"><img src="./images/text-round.png" loading="eager"
                        sizes="(max-width: 2269px) 100vw, 2269px"
                        ...
                        alt="" class="text-circle" /></div>
                <div class="text-circle-container text-circle-container-right"><img src="./images/doutsh-text-round.png"
                        loading="eager" sizes="(max-width: 2310px) 100vw, 2310px"
                        ...
                        alt="" class="text-circle text-circle-right" /></div>
            </div>
            <div id="roadmap" class="section section-road-map _wf-section wf-section not-rendering zero-opacity">
                <img src="./images/bg-roadmap-2.png" alt="" class="image-bg-roadmap">
                <div class="wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                        <div class="section-header"><img src="./images/logo.svg" loading="lazy" alt=""
                                class="site-logo" />
                        ...
                        <div>
                            ...
                            <div class="road-map-slider_item-inner">
                                <div class="road-map-slider_content">
                                    <div class="road-map-slider_subtitle">2022 Q1</div>
                                    <div class="road-map-slider_text">Assembling the team<br><br>Techology testing<br><br>Patent applications<br><br>Website & White Paper <br><br> Token private sale</div>
                                </div>
                                <div class="road-map-slider_content no-right-margin">
                                    <div class="road-map-slider_subtitle">Q2</div>
                                    <div class="road-map-slider_text">MTP token release, Velas Blockchain integration<br><br>Starting the development of MetaPax Glass<br><br> Technical activities (server infrastructure / platform design)
                                    </div>
                                </div>
                                <div class="road-map-slider_content no-right-margin">
                                    <div class="road-map-slider_subtitle">Q3</div>
                                    <div class="road-map-slider_text"><span>Platform BETA Launch, feature demonstration<br /><br />Listing on exchanges<br><br>Global Marketing Campaing</span></div>
                                </div>
                                <div class="road-map-slider_content no-right-margin">
                                    <div class="road-map-slider_subtitle">Q4</div>
                                    <div class="road-map-slider_text"><span>API, integration of third-party wearable devices<br /><br />Project release, connecting Paxers around the world</span></div>
                                </div>
                                <div class="road-map-slider_content no-right-margin">
                                    <div class="road-map-slider_subtitle">2023 Q1</div>
                                    <div class="road-map-slider_text"><span>Full Launch of the project<br><br>Ver 1.0 DAO implementation<br><br>Autostaking release</span></div>
                                </div>
                            </div>
                        </div>
                        <!-- <div>
            ...
            <div class="section time-matters _wf-section how-earn-section wf-section not-rendering zero-opacity">
                <div class="black-bg"></div>
                <img src="./images/bg-time-matters.png" alt="" class="time-matters-bg">
                <span class="blur-3-container">
                    <img src="./images/sea-with-sun.svg" loading="lazy" alt="" class="image-39 blur-3 man-surfing" />
                    <img src="./images/gradient-under-sea.png" alt="" class="gradient-under-sea-image">
                    <img src="./images/drowning-man.svg" alt="" class="drowning-man-image">
                    <img src="./images/surfing-man.svg" alt="" class="surfing-man-image blur-effect-2">
                </span>
                <div class="wrapper w-container" style="z-index: 12;">
                    <div class="section-content not-padding space-between margin-top-none time-matters-container">
                        ...
                        <div class="earn-content-2">
                            <div class="earn-title">
                                ...
                                <div class="your-time">
                                    <div class="text-block-46" id="text-block-46-second" style="position: absolute; opacity: 0;"><span class="text-span-3">Pax creators</span> get more value of their time, spending less money and efforts on transportation and problem solving with classical errands.
                                    </div>
                                    <div class="text-block-46" id="text-block-46-first"><span class="text-span-3">MetaРax Beholders</span> are
                                        getting increased value of their time with concentrated experiences and
                                        on-demand remote execution of whatever they need. And they <span
                                            class="text-span-3-mob"> <br />are happy to pay for it!</span><br /><br />No
                                        more exhausting travelling or time spent on remote problem solving. Be present.
                                    </div>
                                    <div class="text-block-63"><span class="text-span-27">MetaPax</span> Streamers get
                                        your stuff done in minutes, not weeks -- no matter where in the world you are.
                                        Increased efficiency is what will change the world. <br /><br />Streamers will
                                        charge a reasonable fee for their services, but after all - did you ever had a
                                        chance to buy yourself some time before?</div>
                                </div>
                            </div>
                            <div class="earn-image"><img src="./images/man-screen-blur.png" loading="lazy" alt=""
            ...
            <div id="mission"
                class="section-11 sect-mission _wf-section mission-section section wf-section not-rendering zero-opacity">
                <img src="./images/technology-bg.png" alt="" class="bg-tech">
                <img src="./images/new-way-bg.png" alt="" class="new-way-bg">
                <div class="wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none sect-mission-container">
                        ...
                        <h3 class="heading-7 header-title"><span class="text-span-12">Mission</span><br>and vision</h3>
                        <div class="mission-content-container">
                            <div class="columns-8 mission-content w-row">
                                <div class="left-padding-column w-col w-col-5">
                                    <div class="border-text vis-mis" style="display: none;">
                                        
                                        <span
                                            class="text-span-11">Future of
                                            communication</span></div>
                                    <div class="text-block-37 mission-title vis-mis">Technology of
                                        dissolving the borders</div>
                                    <div class="border-text invis-mis" style="display: none;"><span
                                            class="text-span-11">More than
                                            platform.</span></div>
                                    <div class="text-block-37 mission-title invis-mis">It&#x27;s a new way to
                                        life,<br />leisure and work</div>
                                </div>
                                <div class="padding-right-column w-col w-col-5">
                                    ...
                                    <div class="mission-text mis-text-vis">We all are seeing a singification change in
                                        the internet landscape. Just think of it for a moment -- we're devices that were
                                        invented 14 years ago (think iPhone) and are spending time in social networks
                                        that are almost 20 years old (think Facebook). We're literally living in the
                                        past and the change is inevitable - the future should come. We are building this
                                        future.</div>
                                    <div class="mission-text mis-text-invs">
                                        <div class="border-text invis-mis"><span class="text-span-11">MetaPax is a
                                            future</span></div>
                                        How often have you been unable to meet your
                                        ...
                                        with the world through someone else’s eyes. Future has come.</div>
                                ...
                                <div class="not-padding-col w-col w-col-2">
                                    ...
                                    <div class="mission-text mis-text-vis mission-sto">Inspire people to interact with
                                        each other in real time and bring joy in a whole new way</div>
                                    <div class="mission-text mis-text-invs misson-sto">
                                        <div class="border-text invis-mis" style="top: 30px;"><span class="text-span-11">True time
                                            disruption.</span></div>
                                        Never before you were able to be
            ...
            <div id="blockchain"
                class="section blockchain-section wf-section bg-pax-creator not-rendering zero-opacity">
                <div class="wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                        <div class="section-header"><img src="./images/logo.svg" loading="lazy" alt=""
                                class="site-logo" />
                        ...
                        <div class="blockchain-content">
                            <div class="blockchain-text">
                                ...
                                <div class="text-block-54">Lightning fast transactions with minimal fees and enormous
                                    scalability. Support smart contracts. Convenience of integration of the
                                    internal wallet.</div>
                            </div>
            ...
            <div
                class="section-11 section-form _wf-section section contact-section wf-section not-rendering zero-opacity">
                <div class="wrapper w-container">
                    <div class="section-content not-padding">
                        <div class="section-header"><img src="./images/logo.svg" loading="lazy" alt=""
                                class="site-logo" />
                        ...
                        <div class="society-container">
                            <div class="contact-half-section">
                                <a href="http://t.me/metapax" target="_blank" class="society-link w-inline-block">
                                    <div class="w-embed"><svg height="100%" viewBox="0 0 71 72" fill="none"
                                            class="contact-svg" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <a href="http://instagram.com/metapax.io/" target="_blank"
                                    ...
                                    <div class="html-embed-6 w-embed"><svg height="100%" viewBox="0 0 61 61"
                                            class="contact-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <a href="mailto:info@metapax.com?subject=info%40metapax.com"
                                    class="society-link w-inline-block">
                                    <div class="w-embed"><svg height="100%" viewBox="0 0 73 72" fill="none"
                                            class="contact-svg" xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <div class="contact-half-section">
                                <a href="http://twitter.com/metapax_io" target="_blank"
                                    class="society-link w-inline-block">
                                    <div class="html-embed-7 w-embed"><svg height="100%" viewBox="0 0 81 66"
                                            class="contact-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                        ...
                        <div class="form-container contacts-form">
                            <div class="form-block w-form">
                                <form id="email-form" name="email-form" data-name="Email Form" method="post"
                                    class="form"><input type="email" class="text-field w-input" maxlength="256"
                        ...
                        </div><img src="./images/icon.svg" loading="lazy" alt="" class="image-34" />
                        <div class="content-bottom flex-end w-row">
                            <div class="how-works-bottom-text w-col w-col-10"></div>
                            <div class="column-2 pagin pagin-revert w-col w-col-2">
    ...
    <div class="subscribe-modal main-modal">
        <div class="backdrop-filter-menu"></div>
        <div class="subscribe-modal-content second">
            <div class="modal-success-block">
                <p style="text-align: left;">Thank you for joining us,<br>your info was sent correctly!</p>
            </div>
            ...
            </div><a href="#" class="button-5 close-btn w-button form-btn"></a>
        </div>
    </div>
