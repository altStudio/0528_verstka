            ...
            <div id="howitworks" class="section how-works-section _wf-section wf-section mother hidden-vis">
                <div class="wrapper wrapper-relative w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                        ...
                        <div class="text-block-37 vis-mis">It was hard <br />to deliver your <br />vision until now</div>
                        <div class="content-bottom flex-end w-row">
                    ...
                    <div class="section-content not-padding space-between margin-top-none align-center">
                        ...
                        <div class="content-bottom flex-end w-row">
                            ...
                            <div class="column-2 pagin pagin-revert w-col w-col-2">
                                ...
                                <div class="text-block-34 not-border-bottom intro-black no-wrap right">No barrier</div>
                            </div>
                        </div>
                    ...
                    <div class="section-content not-padding margin-top-none space-between last-section">
                        ...
                        <div class="society-container">
                            <a href="http://t.me/metapax" target="_blank" class="society-link w-inline-block">
                                <div class="w-embed"><svg width="70" height="100%" viewBox="0 0 71 72" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <a href="http://instagram.com/metapax.io/" target="_blank"
                                ...
                                <div class="html-embed-6 w-embed"><svg width="70" height="100%" viewBox="0 0 61 61"
                            ...
                            <a href="http://facebook.com/metapax.io" target="_blank"
                                class="society-link w-inline-block">
                                <div class="w-embed"><svg width="70" height="100%" viewBox="0 0 73 72" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <a href="https://www.youtube.com/channel/UCtyhkuP70QFBs_7nUgDbWdA" target="_blank"
                                class="society-link w-inline-block">
                                <div class="w-embed">
                                    <img src="./images/youtube-icon.png" width="70">
                                </div>
                            </a>
                            ...
                            <a href="http://twitter.com/metapax_io" target="_blank" class="society-link w-inline-block">
                                <div class="html-embed-7 w-embed"><svg width="70" height="100%" viewBox="0 0 81 66"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
