...
<body class="body">
                ...
                <div class="section-inner first-inner">
                    <div class="container-3 wrapper w-container">
                        ...
                        <div class="text-block-3">
                            <div class="text-sect first-anim-text">Imagine that you can see the world through someone else’s eyes... Literally</div>
                    ...
                    <div class="section-content not-padding">
                        ...
                        <div class="content-bottom flex-end margin-top-auto w-row">
                            <div class="how-works-bottom-text w-col w-col-10">
                                <div class="text-go center-text alantext">We are building a bridge to Metaverse of experience<br />swhere people can become whoever they choose.</div>
            ...
            <div class="section-10 section section-invert _wf-section wf-section bg-pax-creator">
                <div class="container-4 wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                        ...
                        <div class="content-bottom flex-end w-row">
                            <div class="how-works-bottom-text w-col w-col-10">
                                <div class="text-go center-text _w-960">Being Beholder is very rewarding experience -- <span class="text-span-14">but it also has a lot of</span><br />responsibility tied to it. You will be constantly learning how to interact with streamers and how to get the best out of it, but in the end there is nothing more joyful than to be the one who creates the final picture.</div>
                            </div>
                            <div class="column-2 pagin pagin-revert w-col w-col-2">
                ...
                <div class="container-4 wrapper w-container">
                    <div class="section-content space-between margin-top-none not-padding">
                        ...
                        <div class="div-block-27"><img src="data:image/svg+xml;base64," alt="" class="image-26" />
                            <div class="text-block-33 gradient-text new font-size-120">Earn<br />Evolve<br />Learn</div><img src="./images/boy-with-glasses.svg" loading="lazy" alt="" class="image-27 right-im person-img" />
                        ...
                        <div class="mission-content-container">
                            <div class="columns-8 mission-content w-row">
                                ...
                                <div class="padding-right-column w-col w-col-5">
                                    ...
                                    <div class="mission-text mis-text-vis">We all are seeing a singificant change in the internet landscape. Just think of it for a moment -- we use devices that were invented 14 years ago and spend time in social networks that are almost 20 years old. We&#x27;re literally living in the past and the change is inevitable - the future should come. We are building this future.</div>
                                    <div class="mission-text mis-text-invs">Just yesterday people could not imagine <br />that a car would be electric and a taxi can<br />be called through an app, and now flying <br />autonomous taxis with zero CO2 emissions <br />are almost a reality of our world, something <br />that was only possible in a wild dream <br />or futuristic book from the 70s. <br />Technologies are constantly evolving. <br />But technology alone is not <br />the engine of progress.</div>
                                ...
                                <div class="not-padding-col w-col w-col-2">
                                    ...
                                    <div class="mission-text mis-text-invs misson-sto">We are creating a whole ecosystem that will unite people, allowing you to remotely solve problems anywhere in the world.</div>
                                </div>
    ...
    <div class="menu-modal main-modal">
        ...
        <div class="menu-modal-content">
            ...
            <div class="w-layout-grid grid">
                <a href="#" class="modal-menu-link my-underline go-to-section close-btn-trigger" data-label-number="3">Intro</a>
                <a href="#" class="modal-menu-link my-underline go-to-section close-btn-trigger" data-label-number="18">How it works</a>
                <a href="#" class="modal-menu-link my-underline go-to-section close-btn-trigger" data-label-number="7">Video</a>
                <a href="#" class="modal-menu-link my-underline go-to-section close-btn-trigger" data-label-number="23">Roadmap</a>
                <a href="#" class="modal-menu-link my-underline go-to-section close-btn-trigger" data-label-number="27">Contact</a>
                <a href="" class="modal-menu-link my-underline download" download="">Roadmap</a>
                <a href="" class="modal-menu-link my-underline download" download="">Pitch-deck</a>
            </div>
    ...
    <script src="./main.js?ver=1.5"></script>
