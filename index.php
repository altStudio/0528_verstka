...
<head>
    ...
    <link rel="stylesheet" href="./add.css?ver=1.8">
</head>

<body class="body">
    <script src="./lottie.js"></script>
    <script src="./pace.min.js?ver=1.1"></script>
    <script type="text/javascript">
        window.paceOptions = {
            ajax: false, // disabled
            eventLag: false,
    ...
    <div class="sections-block">
        <div class="secondsect-father">
            <div class="section-2 screenone section first not-padding-top first-head-section wf-section" style="position: fixed; z-index: 13;">
                <div class="section-inner first-inner">
                    ...
                    </div><img src="./images/gradient-2.png" loading="eager" sizes="100vw" alt="" class="image-7" /><img src="./images/gradient-1.png" loading="eager" sizes="100vw" alt="" class="image-6" />
            ...
            <div id="3sec" class="section-3 section wf-section">
                ...
                </div><img src="./images/gradient-3.png" loading="eager" sizes="(max-width: 1884px) 100vw, 1884px" srcset="./images/colorful-circle-500.png 500w, ./images/colorful-circle-800.png 800w, ./images/colorful-circle-1080.png 1080w, ./images/colorful-circle-1600.png 1600w, ./images/colorful-circle.png 1884w" alt="" class="image-10" /><img src="./images/gradient-4.png" loading="eager" sizes="(max-width: 1395px) 100vw, 1395px" srcset="./images/colorful-circle2-500.png 500w, ./images/colorful-circle2-800.png 800w, ./images/colorful-circle2-1080.png 1080w, ./images/colorful-circle2.png 1395w" alt="" class="image-11" />
            </div>
                        ...
                        <div class="what-do-content">
                            <div class="what-do-text">
                                ...
                                <div class="div-block-26">
                                    ...
                                    <div class="text-go marcel-3 hide-for-mob">Whenever you need to appear on the other part of the world -- it’s all ready for you: join the ongoing streaming sessions or request a new one on your terms.</div>
                                    <div class="text-block-59 marcel-4 hide-for-mob">You can choose what to stream according to thousands of different requests available to you, depending on what you’re up to today. Explore the world together with other people and have fun!</div>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="text-go marcel-3 hide-for-desk">Whenever you need to appear on the other part of the world -- it’s all ready for you: join the ongoing streaming sessions or request a new one on your terms.</div>
                            <div class="text-block-59 marcel-4 hide-for-desk">You can choose what to stream according to thousands of different requests available to you, depending on what you’re up to today. Explore the world together with other people and have fun!</div>
                        </div>
                        <div class="content-bottom flex-end w-row">
                            <div class="column-2 w-col w-col-2">
                                <div class="text-block-19 pagin-white">02<span class="text-span-8">/10</span></div>
        ...
        <div class="mother">
            ...
            <div class="section-10 section-offer _wf-section earns-section-2 section wf-section bg-earn-learn-evolve2">
                <div class="container-4 wrapper w-container">
                    <div class="section-content not-padding space-between margin-top-none">
                        <div class="section-header"><img src="./images/logo.svg" loading="lazy" alt="" class="site-logo" />
                            <div class="site-menu custom-menu">menu</div>
            ...
            <div class="section marque-glasses _wf-section wf-section">
                ...
                <div class="text-circle-container">
                    <img src="./images/text-round.png" loading="eager" sizes="(max-width: 2269px) 100vw, 2269px" srcset="./images/text-round-500.png 500w, ./images/text-round-800.png 800w, ./images/text-round-1080.png 1080w, ./images/text-round-1600.png 1600w, ./images/text-round.png 2269w" alt="" class="text-circle" />
                </div>
                <div class="text-circle-container text-circle-container-right">
                    <img src="./images/doutsh-text-round.png" loading="eager" sizes="(max-width: 2310px) 100vw, 2310px" srcset="./images/doutsh-text-round-500.png 500w, ./images/doutsh-text-round-800.png 800w, ./images/doutsh-text-round-1080.png 1080w, ./images/doutsh-text-round-1600.png 1600w, ./images/doutsh-text-round.png 2310w" alt="" class="text-circle text-circle-right" />
                </div>
            </div>
                ...
                <div class="wrapper w-container">
                    <div class="section-content not-padding">
                        ...
                        <div class="section-title">
                            ...
                            <div class="text-block-41">Follow us on social media to stay <br />informed and inspired!</div>
                        </div>
                        <div class="society-container">
                            ...
                            <a href="mailto:info@metapax.io?subject=info%40metapax.io" class="society-link w-inline-block">
                                <div class="w-embed"><svg width="73" height="100%" viewBox="0 0 73 72" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="menu-modal main-modal">
        ...
        <div class="menu-modal-content">
            ...
            <div class="w-layout-grid grid">
                ...
                <a href="https://whitepaper.metapax.io/" class="modal-menu-link my-underline" download="" target="_blank">White Paper</a>
